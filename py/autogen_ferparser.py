...
class Realm(object):
  def __init__(self, **args):
    StrictNamedArguments({'domains': {}})(self, args)
Ws = str
PseudoLetter = str
Dot = str
Domain = str
...
class Expression(object):
  def __init__(self, **args):
    StrictNamedArguments({'lookup': {}, 'id': {}, 'arguments': {}})(self, args)
class ExpressionArgument(object):
  def __init__(self, **args):
    StrictNamedArguments({'expression': {}, 'id': {}})(self, args)
class VariableConstraint(object):
  def __init__(self, **args):
    StrictNamedArguments({'expression': {}, 'id': {}})(self, args)
class TransformDefinition(object):
  def __init__(self, **args):
    StrictNamedArguments({'expression': {}, 'locals': {}, 'constraints': {}})(self, args)
Id = str
...
class FerParser(object):
  ...
  def parse_pseudo_letter(self):
    return self._reader.parse_type(
      ...
      parsers=[
        ('_', 'expected pseudo-letter', lambda: self._reader.consume_string(SimpleClassPredicate('a-zA-Z_'), 1, 1))
      ],
      result_immediate='_')
  def parse_dot(self):
    return self._reader.parse_type(
      ...
      error='expected dot',
      parsers=[
        ('_', 'expected dot', lambda: self._reader.consume_string(StringPredicate('.'), 1, 1))
      ],
      result_immediate='_')
  def parse_domain(self):
    return self._reader.parse_type(
      ...
      parsers=[
        ('_', 'expected domain', lambda: self._reader.consume_string(StringPredicate('domain'), 6, 6))
      ],
      result_immediate='_')
  def parse_left_curly_bracket(self):
    return self._reader.parse_type(
      ...
      parsers=[
        ('_', 'expected left-curly-bracket', lambda: self._reader.consume_string(StringPredicate('{'), 1, 1))
      ],
      result_immediate='_')
  def parse_right_curly_bracket(self):
    return self._reader.parse_type(
      ...
      parsers=[
        ('_', 'expected right-curly-bracket', lambda: self._reader.consume_string(StringPredicate('}'), 1, 1))
      ],
      result_immediate='_')
  def parse_vertical_line(self):
    return self._reader.parse_type(
      ...
      parsers=[
        ('_', 'expected vertical-line', lambda: self._reader.consume_string(StringPredicate('|'), 1, 1))
      ],
      result_immediate='_')
  def parse_colon(self):
    return self._reader.parse_type(
      ...
      parsers=[
        ('_', 'expected colon', lambda: self._reader.consume_string(StringPredicate(':'), 1, 1))
      ],
      result_immediate='_')
  def parse_greater_than_sign(self):
    return self._reader.parse_type(
      ...
      parsers=[
        ('_', 'expected greater-than-sign', lambda: self._reader.consume_string(StringPredicate('>'), 1, 1))
      ],
      result_immediate='_')
  def parse_equals_sign(self):
    return self._reader.parse_type(
      ...
      parsers=[
        ('_', 'expected equals-sign', lambda: self._reader.consume_string(StringPredicate('='), 1, 1))
      ],
      result_immediate='_')
  def parse_dollar_sign(self):
    return self._reader.parse_type(
      ...
      parsers=[
        ('_', 'expected dollar-sign', lambda: self._reader.consume_string(StringPredicate('$'), 1, 1))
      ],
      result_immediate='_')
  def parse_left_parenthesis(self):
    return self._reader.parse_type(
      ...
      parsers=[
        ('_', 'expected left-parenthesis', lambda: self._reader.consume_string(StringPredicate('('), 1, 1))
      ],
      result_immediate='_')
  def parse_right_parenthesis(self):
    return self._reader.parse_type(
      ...
      parsers=[
        ('_', 'expected right-parenthesis', lambda: self._reader.consume_string(StringPredicate(')'), 1, 1))
      ],
      result_immediate='_')
  def parse_tilde(self):
    return self._reader.parse_type(
      ...
      parsers=[
        ('_', 'expected tilde', lambda: self._reader.consume_string(StringPredicate('~'), 1, 1))
      ],
      result_immediate='_')
  def parse_solidus(self):
    return self._reader.parse_type(
      ...
      parsers=[
        ('_', 'expected solidus', lambda: self._reader.consume_string(StringPredicate('/'), 1, 1))
      ],
      result_immediate='_')
  def parse_percent_sign(self):
    return self._reader.parse_type(
      ...
      parsers=[
        ('_', 'expected percent-sign', lambda: self._reader.consume_string(StringPredicate('%'), 1, 1))
      ],
      result_immediate='_')
  def parse_octothorp(self):
    return self._reader.parse_type(
      ...
      parsers=[
        ('_', 'expected octothorp', lambda: self._reader.consume_string(StringPredicate('#'), 1, 1))
      ],
      result_immediate='_')
  ...
  def parse_id(self):
    return self._reader.parse_type(
      ...
      parsers=[
        ...
        ('_', 'expected pseudo-letter in id', lambda: self._reader.consume_string(SimpleClassPredicate('a-zA-Z_'), 1, 9223372036854775807)),
      ],
      result_immediate='_')
